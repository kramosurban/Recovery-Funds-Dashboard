...
<h1>DRAFT Recovery Funds Dashboard</h1>

</center>

<center>**This is a draft product and is subject to frequent changes. The dashboard and any data within it should not be cited or distributed.**</center>
...
This dashboard aims to track a subset of the federal recovery funds flowing into the City of Chicago, Cook County, and the State of Illinois that can be used for inclusive recovery efforts that align with key priorities of the Chicago Community Trust, reflected in the "policy area" dropdown menu. The dashboard primarily tracks appropriations, or how much funding the the federal government has committed to provide to local jurisdictions. For a few select programs where information is available, the dashboard also explores spending by zip code.

**The inclusive recovery funds we track represent a subset of Covid-19 assistance provided by the federal government.** The dashboard only reflects funds flowing directly from the federal government to the state of Illinois, Cook County, and the City of Chicago, and does not include funds provided from the federal government directly to public housing authorities, school districts, universities, or nongovernmental organizations, such as non-profits or private sector firms. Information on program allocations will be added as new data become available. For more information on how we identified and tracked these funds, see our [Frequently Asked Questions](faq.html).
...
write_csv(data, here("data/intermediate_data", "clean_data_dashboard.csv"))
```
...
<font size = "2">Hover your cursor over a zipcode on the map below to see data for that zipcode</font>
