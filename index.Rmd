...
The dashboard explores the funding by five different policy areas (community investment, community safety, household investment, housing, and workforce development) as well as uncategorized state/local discretionary funding. [Download data on all of the programs included in the dashboard (.zip)](https://federal-funds-equity.s3.amazonaws.com/all_programs_total.zip)
...
leaflet_grid <- tagList(list(
    tags$div(
      style = 'width:510px;display:block;float:left;margin-right:35px',
      chi_map
    ),
    tags$div(
