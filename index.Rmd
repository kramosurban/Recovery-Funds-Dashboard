...
Federal pandemic-response packages have provided unprecedented aid to state and local governments, including \$800 billion that can be used flexibly to promote an inclusive recovery. These resources create an unparalleled opportunity for advocates and local decision-makers to ensure federal funds reach communities that need them most, close equity gaps exacerbated by the pandemic, and address the root causes of inequities. To take advantage of this opportunity, local leaders need timely data and evidence to ensure funds are used effectively and equitably.
...
We will add more program allocation and spending information as new data become available. For more information on how we identified and tracked these funds, see our [Frequently Asked Questions](faq.html).

**The inclusive recovery funds we track represent a subset of Covid-19 assistance provided by the federal government.** The dashboard only reflects funds flowing directly from the federal government to the State of Illinois, Cook County, and the City of Chicago. It does not include funds provided by the federal government directly to public housing authorities, school districts, universities, or nongovernmental organizations, such as non-profits or private sector firms. 
